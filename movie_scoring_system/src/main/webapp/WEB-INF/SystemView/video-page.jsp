            ...
            <div class="container-fluid position-relative">
                <div class="row">
                    <div class="col-7 col-md-4">
                        <a href="${pageContext.request.contextPath}/index" class="tm-bg-black text-center tm-logo-container">
                                ...
                                <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                    <ul class="navbar-nav text-uppercase">
                                        <li class="nav-item active">
                                            <a class="nav-link tm-nav-link" href="${pageContext.request.contextPath}/index">Videos <span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link tm-nav-link" href="${pageContext.request.contextPath}/about">About</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="row tm-catalog-item-list">
                            <div class="col-lg-4 col-md-6 col-sm-12 tm-catalog-item">
                                <div class="position-relative tm-thumbnail-container">
                                    ...
                                    <a href="${pageContext.request.contextPath}/video-page" class="position-absolute tm-img-overlay">
